...
function viewitem(grn, rowno) {
    ...
    tdaddeddate.innerHTML = grn.addeddate;
    tdporder.innerHTML = grn.porder_id.pordercode;
    tdgrnstatus.innerHTML = grn.grnstatus_id.name;
...
function cmbSupplierMC(){
 ...
 function loadForm() {
    ...
    fillCombo(cmbGRNStatus, "Select grn", grnstatuses, "name", "Pending");
...
function filldata(grnote) {
    ...
    fillCombo(cmbEmployee, "", employees, "callingname", session.getObject('activeuser').employeeId.callingname);
    fillCombo(cmbGRNStatus, "", grnstatuses, "name", "Available");
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        if (response == "0") {
                            ...
                            loadSearchedTable();
                            loadForm();
                            $('#formModal').modal('hide'); //hide the model after update
